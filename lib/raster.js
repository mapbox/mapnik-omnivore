...
Raster.prototype.getZooms = function(callback) {
  ...
  happytiff.info(this.filepath, function(err, info) {
      minzoom = info.z;
      console.log(minzoom);
      console.log(info);
    return callback(
  ...
  // call node-happytiff against this.Raster to see if happytiff
  // if yes -- use Z returned from node-happytiff as minzoom
  // if not, run regular math.max logic and create minzoom var
  // also create maxzoom var
