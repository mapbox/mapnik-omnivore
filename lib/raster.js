...
module.exports.convertToMeters = convertToMeters;
module.exports.getSpatialResolutions = getSpatialResolutions;
module.exports.getUnitType = getUnitType;
module.exports.getValidSpatialResolutions = getValidSpatialResolutions;
...
function getValidSpatialResolutions(spatialResolutions, pixelSize) {
...
Raster.prototype.getZooms = function(callback) {
  ...
  var spatialResolutions = getSpatialResolutions();

  var _this = this;
  var validSpatialResolutions = getValidSpatialResolutions(spatialResolutions, _this.details.pixelSize[0]);
