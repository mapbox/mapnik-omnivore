...
function getMinMaxZoomGDAL(pixelSize, center, proj, callback) {
    ...
    // TODO: Handle other unit conversions
    if (getUnitType(proj) === "decimal degrees") {
      // Assuming every latitude is like the equator
      spatialResolution = pixelSize[0] / 360 * circumference;
      pixelSize = [spatialResolution, -1 * spatialResolution]
    }
