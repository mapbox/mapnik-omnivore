...
function projectionFromRaster(file, callback) {
    ...
    try {
        ...
        for(var i = 1; i <= bandCount; i++){
            ...
            bands.push({
                ...
                'scale':band.getScale(),
                'rasterDatatype':band.getRasterDataType(),
                'categoryNames':band.getCategoryNames(),
                'nodata':nodata
            });
        };
    ...
    if(srsResult.proj4 === undefined){
        ...
        'raster':{
            ...
            'width': width,
            'height': height,
            //TODO: unit will be detected somehow...probably from the EPSG string. Can't find it in node-gdal.
            'unit': 'meters',
            'nodata': nodata,
