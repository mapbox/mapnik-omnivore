...
function getDatasourceConfigs(file, filesize, filetype, callback) {
    console.log("in getDatasourceConfigs");
...
function projectionFromRaster(file, callback) {
    console.log("in projectionFromRaster");
    var ds;
    var proj;
    var band;
    var bandCount;
    ...
    try {
        ...
        for(var i = 1; i <= bandCount; i++){
            console.log("in bandloop");
            band = ds.bands.get(i);
            console.log("after getband");
            console.log(file);
            console.log(band);
        ...
        //get srs string
        console.log("before srsResult");
        srsResult = srs.parse(proj);
        console.log("after srsResult");
